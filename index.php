...
<div class="theme-layout">
	...
	<div class="responsive-header">
		<div class="mh-head first Sticky">
			...
			<span class="mh-text">
				<a href="newsfeed.html" title=""><img src="images/1x.png" alt=""></a>
			</span>
			...
			<ul>
				<li><span>Home</span>
					<ul>
						...
						<li><a href="newsfeed.html" title="">Feed</a></li>
					</ul>
				</li>
	...
	<div class="topbar stick">
		<div class="logo">
			<a title="" href="newsfeed.html"><img src="images/1x.png" alt="" width="40%" height="40%"></a>
		</div>
		...
		<div class="top-area">
			<ul class="main-menu">
				...
				<li>
					...
					<ul>
						<li><a href="about.html" title="">about SmartSocial</a></li>
			...
			<div class="row">
				<div class="col-lg-4 col-md-4">
					<div class="widget">
						<div class="foot-logo">
							<div class="logo">
								<a href="index.php" title=""><img src="images/1x.png" alt="" width="60%" height="60%"></a>
							</div>	
							<p>
								A group of eight joined together to build world's safest social platform for all Your personal data.
							</p>
						</div>
						<ul class="location">
							<li>
